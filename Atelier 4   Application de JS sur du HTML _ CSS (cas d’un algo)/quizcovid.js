...
let champObligatoire = document.getElementById("temp");
...
function vérifier(event) {
  ...
  let reponse = '';
  if (champObligatoire.value == "") {
    reponse = ("Le champ temperature est obligatoire pour continuer le quiz");
  }
  else if (temperature >= 38 &&  symptomes.length > 1 || respiration >= 2 || contact == 1 || voyage == 1) {
